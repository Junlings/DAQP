...
includes = ["wx.lib.pubsub.*", "wx.lib.pubsub.core.*", "wx.lib.pubsub.pubsub1.*", "wx.lib.pubsub.pubsub2.*", "wx.lib.pubsub.utils.*" ,"ctypes", "logging","xml"]
excludes = ['_gtkagg', '_tkagg', 'bsddb', 'curses', 'email', 'pywin.debugger',
            'pywin.debugger.dbgcon', 'pywin.dialogs', 'tcl',
            'Tkconstants', 'Tkinter']
packages = ['pytz','wx.lib.pubsub','xml']
